<template>
    <div class="memo">
        <b-button pill variant="outline-info" v-b-modal="memo1_modal_id"><b-icon icon="journal-text" aria-hidden="true"></b-icon></b-button>
        <b-modal :id=memo1_modal_id title="メモ" hide-footer size="lg">
            <p>①在籍年数毎に求めるもの</p>
            <div>
