        ...
        <section>
            <div>
                <b-container class="bv-example-row">
                    <b-row>
                        <b-col cols="2"><b-button v-b-toggle="collapse_id" variant="primary">+</b-button><p class="evaluation-num">{{evaluation_num}}評価</p></b-col>
                ...
                <b-collapse :id=collapse_id class="mt-2">
                    <b-card>
                        <b-container class="bv-example-row">
                            ...
                            <b-row align-h="start">
                                <b-col cols="1"><b-badge pill variant="info">{{ count_sm }}次評点</b-badge></b-col>
                                <b-col cols="5"><p class="label-text">3</p></b-col>
                            </b-row>
                            <div class="comment">
                                <b-badge pill variant="info">{{ count_sm }}次コメント</b-badge>
                                <p class="comment-text">いいと思います。</p>
                            </div>
                        </b-container>
                    ...
                    <b-card>
                        ...
                        <b-container class="bv-example-row">
                            ...
                            <div class="comment">
                                <b-badge pill variant="info">{{ count_sm }}次コメント</b-badge>
                                <p class="comment-text">もう少し頑張ってください。</p>
                            </div>
                        </b-container>
                    </b-card>
                </b-collapse>
...
<script>
    export default {
        name: 'evaluation',
        props:['evaluation_num','collapse_id','count_sm'],
        methods:{
            edidEvent(){
